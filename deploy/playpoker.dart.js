...
$$.I9={"":"HU;Gx,AO",
Pq:function(a){},
wb:function(a){var z=this.AO
if(z.t(z,a)!=null)return
z.u(z,a,!0)
$.kH(a,new $.XT(this))},
w5:function(a){var z=this.AO
if(z.t(z,a)!=null)return
z.u(z,a,!0)
...
y.CH(y)
z=null
try{z=this.Q1(a)}finally{this.AO.F4()}return z},
...
n:function(a,b){if(b==null)return!1
return typeof b==="object"&&b!==null&&!!$.x(b).$iscu&&$.de(this.rT,b.rT)},
$iscu:true}
$$.O={"":"String/vB;",
...
z.b=0
y=this.Wr
for(;x=z.b,w=$.vd(x),w.C(x,y.length);z.b=$.WB(z.b,1)){if(w.D(x,0)){x=z.a
x.Ek=x.Ek+", "}x=z.a
w=z.b
...
v=z[w]
if(this.JM(v))y.push(v.localName)}return y},
gUQ:function(a){var z,y,x,w,v
z=this.xE.attributes
y=$.A($)
for(x=z.length,w=0;w<x;++w){if(w>=z.length)throw $.e(w)
v=z[w]
if(this.JM(v))y.push($.Vm(v))}return y},
gl0:function(a){return this.gB(this)===0},
$isT8:true,
...
this.k6.v9=[]},
Jg:function(a){var z
for(;a.kw.length<5;){z=this.PU()
if(!this.Ae(z)){this.nj.push(z)
a.kw.push(z)}}},
PU:function(){var z,y
z=4
y=Math.random()*z>>>0
z=13
return $.cK(y,2+(Math.random()*z>>>0))},
Ae:function(a){var z,y,x,w,v,u,t
for(z=$.Z9c.gA(this.nj),y=a.Mb,x=a.r,w=a.CU,v=a.YC;z.G();){u=z.gl().GV()
if(x<0||x>=y.length)throw $.e(x)
t=$.d(y[x])+" of "
if(v<0||v>=w.length)throw $.e(v)
if(u===t+$.d(w[v]))return!0}return!1},
xb:function(a){var z,y,x,w,v,u,t
z=$.FK()
for(y=$.Z9c.gA(a.kw);y.G();){x=y.gl()
w=$.RE(x)
v=z.t(z,w.gr(x))
w=w.gr(x)
if(v==null)z.u(z,w,1)
else z.u(z,w,$.WB(z.t(z,w),1))}for(y=z.gUQ(z),y=y.gA(y),u=0;y.G();){t=y.gl()
if(typeof t!=="number")$.vh($.u(t))
u+=Math.pow(t,2)}a.Pi=u
switch(u){case 5:this.O1(a)
break
case 7:a.wI="Pair"
break
case 11:a.wI="Three Of A Kind"
break
case 9:a.wI="Two Pairs"
break
case 13:a.wI="Fullhouse"
break
case 17:a.wI="Four Of A Kind"
break}return a.wI},
...
if(4>=y)throw $.e(4)
t=[x,w,v,u,$.Y3(z[4])]
if(!!t.immutable$list)$.vh($.f("sort"))
s=$.n4
z=t.length-1
if(z-0<=32)$.z2(t,0,z,s)
else $.d4(t,0,z,s)
if(4>=t.length)throw $.e(4)
if($.de(t[4],$.WB(t[0],4)))if(this.UB(a)){a.wI="Straight Flush"
a.Pi=18}else{a.wI="Straight"
a.Pi=12}else{if(4>=t.length)throw $.e(4)
if($.de(t[4],14)){if(0>=t.length)throw $.e(0)
if($.de(t[0],2)){if(3>=t.length)throw $.e(3)
z=$.de(t[3],5)}else z=!1}else z=!1
if(z)if(this.UB(a)){a.wI="Straight Flush"
a.Pi=18}else{a.wI="Straight"
a.Pi=12}else if(this.UB(a)){a.wI="Flush"
a.Pi=14}else{a.wI="High Card"
a.Pi=1}}},
...
if(!$.de(t[s],t[r]))return!1}return!0},
vl:function(){var z,y
z=this.L4.Pi
y=this.k6.Pi
if($.xZ(z,y))return $.AJ(["humanWinner",!0,"reason","you have a higher hand."])
else if(z==null?y==null:z===y)switch(z){case 1:return this.OE()
...
z=$.cK(0,0)
y=$.cK(0,0)
for(x=$.Z9c.gA(this.L4.kw);x.G();){w=x.gl()
if($.xZ(w,z))z=w}for(x=$.Z9c.gA(this.k6.kw);x.G();){w=x.gl()
if($.xZ(w,y))y=w}if($.xZ(z,y))return $.AJ(["humanWinner",!0,"reason","you have a higher High Card"])
...
for(x=$.Z9c.gA(this.k6.kw);x.G();){w=x.gl()
v=$.RE(w)
u=t.t(t,v.gr(w))
v=v.gr(w)
if(u==null)t.u(t,v,[w])
...
v=z.c
u=$.vd(x)
if(u.D(x,v))return $.AJ(["humanWinner",!0,"reason","you have a higher Pair."])
else if(u.C(x,v))return $.AJ(["humanWinner",!1,"reason","you have a lower Pair."])
else{for(z=$.GP(z.b),s=!1;z.G()===!0;)if(z.gl().gYC()===3)s=!0
...
XS:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=$.AJ([])
y=$.AJ([])
x=[]
w=[]
for(v=$.Z9c.gA(this.L4.kw);v.G();){u=v.gl()
t=$.RE(u)
s=z.t(z,$.AG(t.gr(u)))
t=t.gr(u)
if(s==null)z.u(z,$.AG(t),1)
else{t=$.AG(t)
z.u(z,t,$.WB(z.t(z,t),1))}}for(v=$.Z9c.gA(this.k6.kw);v.G();){u=v.gl()
t=$.RE(u)
s=y.t(y,$.AG(t.gr(u)))
t=t.gr(u)
if(s==null)y.u(y,$.AG(t),1)
else{t=$.AG(t)
y.u(y,t,$.WB(y.t(y,t),1))}}z.aN(z,new $.qT(x))
y.aN(y,new $.UP(w))
if(!!x.immutable$list)$.vh($.f("sort"))
r=$.n4
v=x.length-1
if(v-0<=32)$.z2(x,0,v,r)
else $.d4(x,0,v,r)
if(!!w.immutable$list)$.vh($.f("sort"))
r=$.n4
v=w.length-1
if(v-0<=32)$.z2(w,0,v,r)
else $.d4(w,0,v,r)
if(0>=x.length)throw $.e(0)
q=$.Hp($.AG(x[0]),null,null)
if(typeof q!=="number")return this.aU(1,w,q,x)
if(0>=w.length)throw $.e(0)
p=$.Hp($.AG(w[0]),null,null)
if(1>=x.length)throw $.e(1)
o=$.Hp($.AG(x[1]),null,null)
if(typeof o!=="number")return this.aU(2,w,q,0,p,o)
if(1>=w.length)throw $.e(1)
n=$.Hp($.AG(w[1]),null,null)
if($.Pda.D(o,n))return $.AJ(["humanWinner",!0,"reason","you have a higher Two Pairs."])
else if($.Pda.C(o,n))return $.AJ(["humanWinner",!1,"reason","you have a lower Two Pairs."])
else if($.Pda.D(q,p))return $.AJ(["humanWinner",!0,"reason","you have a higher Two Pairs."])
else if($.Pda.C(q,p))return $.AJ(["humanWinner",!1,"reason","you have a lower Two Pairs."])
else{for(v=$.Z9c.gA(this.L4.kw),m=!1;v.G();){u=v.gl()
if($.Y3(u)===o)m=u.gYC()===3?!0:m}if(!m)for(v=$.Z9c.gA(this.L4.kw);v.G();){u=v.gl()
if($.Y3(u)===q)m=u.gYC()===3?!0:m}if(m)return $.AJ(["humanWinner",!0,"reason","you have the card of Spades."])
return $.AJ(["humanWinner",!1,"reason","computer has the card of Spades."])}},
...
u=z.t(z,$.AG(v.gr(w)))
v=v.gr(w)
if(u==null)z.u(z,$.AG(v),1)
else{v=$.AG(v)
z.u(z,v,$.WB(z.t(z,v),1))}}for(x=$.Z9c.gA(this.k6.kw);x.G();){w=x.gl()
v=$.RE(w)
u=y.t(y,$.AG(v.gr(w)))
v=v.gr(w)
if(u==null)y.u(y,$.AG(v),1)
else{v=$.AG(v)
y.u(y,v,$.WB(y.t(y,v),1))}}z.aN(z,new $.qT(d))
y.aN(y,new $.UP(b))
if(!!d.immutable$list)$.vh($.f("sort"))
t=$.n4
x=d.length-1
if(x-0<=32)$.z2(d,0,x,t)
else $.d4(d,0,x,t)
if(!!b.immutable$list)$.vh($.f("sort"))
t=$.n4
x=b.length-1
if(x-0<=32)$.z2(b,0,x,t)
else $.d4(b,0,x,t)
if(0>=d.length)throw $.e(0)
c=$.Hp($.AG(d[0]),null,null)
case 1:a=0
if(0>=b.length)throw $.e(0)
e=$.Hp($.AG(b[0]),null,null)
if(1>=d.length)throw $.e(1)
f=$.Hp($.AG(d[1]),null,null)
case 2:var z,y,x,w,v,u,t,s,r
a=0
if(1>=b.length)throw $.e(1)
s=$.Hp($.AG(b[1]),null,null)
x=$.vd(f)
if(x.D(f,s))return $.AJ(["humanWinner",!0,"reason","you have a higher Two Pairs."])
else if(x.C(f,s))return $.AJ(["humanWinner",!1,"reason","you have a lower Two Pairs."])
else{x=$.vd(c)
if(x.D(c,e))return $.AJ(["humanWinner",!0,"reason","you have a higher Two Pairs."])
else if(x.C(c,e))return $.AJ(["humanWinner",!1,"reason","you have a lower Two Pairs."])
else{for(x=$.Z9c.gA(this.L4.kw),r=!1;x.G();){w=x.gl()
v=$.Y3(w)
if(v==null?f==null:v===f)r=w.gYC()===3?!0:r}if(!r)for(x=$.Z9c.gA(this.L4.kw);x.G();){w=x.gl()
v=$.Y3(w)
if(v==null?c==null:v===c)r=w.gYC()===3?!0:r}if(r)return $.AJ(["humanWinner",!0,"reason","you have the card of Spades."])
return $.AJ(["humanWinner",!1,"reason","computer has the card of Spades."])}}}},
...
z.a=null
z.b=null
for(w=$.Z9c.gA(this.L4.kw);w.G();){v=w.gl()
u=$.RE(v)
t=y.t(y,$.AG(u.gr(v)))
u=u.gr(v)
if(t==null)y.u(y,$.AG(u),1)
else{u=$.AG(u)
y.u(y,u,$.WB(y.t(y,u),1))}}for(w=$.Z9c.gA(this.k6.kw);w.G();){v=w.gl()
u=$.RE(v)
t=x.t(x,$.AG(u.gr(v)))
u=u.gr(v)
if(t==null)x.u(x,$.AG(u),1)
else{u=$.AG(u)
x.u(x,u,$.WB(x.t(x,u),1))}}y.aN(y,new $.Kd(z))
x.aN(x,new $.xE(z))
...
this.xb(this.L4)
this.xb(this.k6)
var z="You have a <b>"+$.d(this.L4.wI)+"</b>. You can now change up to 4 cards or jump to showdown"
$.Qy(document.querySelector("#status"),z)},
Va:function(){var z,y,x,w
this.ZQ=2
for(z=$.Z9c.gA(this.L4.v9);y=z.G(),x=this.L4,y;){w=z.gl()
$.Z9c.Rz(x.kw,w)}this.Jg(x)
this.xb(this.L4)
this.eX()},
eX:function(){var z,y
this.ZQ=3
$.lS(this,!0)
$.DG()
z=document.querySelector("#showdown").style
y=$.RE(z)
y.sSW(z,"hidden")
y.suL(z,"none")
z="You have a <b>"+$.d(this.L4.wI)+"</b>, computer has a <b>"+$.d(this.k6.wI)+"</b>: "+$.xK(this.vl())
$.Qy(document.querySelector("#status"),z)}}
$$.WW={"":"Tp;a",
call$2:function(a,b){var z
if($.de($.q8(b),2)){z=this.a
z.a=a
z.b=b}}}
$$.Ky={"":"Tp;a",
call$2:function(a,b){var z
...
z.d=b}}}
$$.qT={"":"Tp;a",
call$2:function(a,b){if($.de(b,2))this.a.push(a)}}
$$.UP={"":"Tp;b",
call$2:function(a,b){if($.de(b,2))this.b.push(a)}}
$$.Kd={"":"Tp;a",
call$2:function(a,b){if($.de(b,3))this.a.a=$.Hp(a,null,null)}}
$$.xE={"":"Tp;a",
call$2:function(a,b){if($.de(b,3))this.a.b=$.Hp(a,null,null)}}
$$.H2={"":"a;r>,YC<,CU,Mb",
...
y=this.YC
if(y<0||y>=z.length)throw $.e(y)
return"cards/"+$.Mz($.UQ(z[y],0))+this.r+".png"},
D:function(a,b){var z,y
z=this.r
y=$.Y3(b)
if($.Pd.D(z,y))return!0
else if(z===y)if(this.YC>b.gYC())return!0
return!1},
C:function(a,b){var z,y
z=this.r
y=$.Y3(b)
if($.Pd.C(z,y))return!0
else if(z===y)if(this.YC<b.gYC())return!0
return!1},
n:function(a,b){if(b==null)return!1
...
z.k6=y
x={}
for(x.a=1;w=x.a,$.u6(w,6);v={},v.a=x.a,v.a=$.WB(v.a,1),x=v){w="#h"+$.d(w)
w=document.querySelector(w)
w.gVl
w=$.U9.aM(w)
$.JE(w.MP,w.mE,new $.em(x,z),w.Gd)}$.Br(z)
z.ZQ=0
z.AJ()
w=document.querySelector("#newHand")
w.gVl
w=$.U9.aM(w)
$.JE(w.MP,w.mE,new $.Lb(z),w.Gd)
w=document.querySelector("#showdown")
w.gVl
w=$.U9.aM(w)
$.JE(w.MP,w.mE,new $.QA(z),w.Gd)}
...
z=$.OY()
z.u(z,"h5",!1)
z=document.querySelector("#showdown")
z.textContent="Showdown"
$.Bz(z,["btn","btn-info"])
y=z.style
y.sSW
$.X9(y,"visibility","visible","")
z=z.style
z.suL
$.X9(z,"display","inline","")
for(z=$.Z9c.gA(["c1","c2","c3","c4","c5","h1","h2","h3","h4","h5"]);z.G();){y="#"+$.d(z.gl())
...
x="#h"+y
x=document.querySelector(x).style
w=a.L4.kw
...
z=$.OY()
if(z.t(z,"h"+$.d(b))===!0){z=$.OY()
y="h"+$.d(b)
x=$.OY()
z.u(z,y,x.t(x,"h"+$.d(b))!==!0)
x=a.L4
y=x.v9
x=x.kw
z=$.xH(b,1)
...
z="h"+$.d(b)
y=$.OY()
x.u(x,z,y.t(y,"h"+$.d(b))!==!0)
w=25}else{$.Qy(document.querySelector("#status"),"You can change only 4 cards.")
w=0}}z=$.OY()
z=z.gUQ(z)
if(z.tg(z,!0)){z=document.querySelector("#showdown")
$.Bz(z,["btn","btn-success"])
z.textContent="Change cards and jump to Showdown"}else{z=document.querySelector("#showdown")
$.Bz(z,["btn","btn-info"])
...
z.sUu
$.X9(z,"margin-top",y,"")}
$.xK=function(a){return $.Ca.g($.Ca.g(a.t(a,"humanWinner")===!0?"you won ":"computer won ","because "),a.t(a,"reason"))}
$.DG=function(){var z=document.querySelector("#h1").style
z.sUu
$.X9(z,"margin-top","0px","")
z=document.querySelector("#h2").style
z.sUu
$.X9(z,"margin-top","0px","")
z=document.querySelector("#h3").style
z.sUu
$.X9(z,"margin-top","0px","")
z=document.querySelector("#h4").style
z.sUu
$.X9(z,"margin-top","0px","")
z=document.querySelector("#h5").style
z.sUu
$.X9(z,"margin-top","0px","")}
